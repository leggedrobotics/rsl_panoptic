...
class CommonTest(tf.test.TestCase):
    def test_constants_keys(self):
        ...
        self.assertEqual(common.GT_INSTANCE_REGRESSION_KEY, "instance_regression_gt")
        ...
        self.assertEqual(common.REGRESSION_LOSS_WEIGHT_KEY, "regression_loss_weight")
        self.assertEqual(
            common.FRAME_REGRESSION_LOSS_WEIGHT_KEY, "frame_regression_loss_weight"
        )
        ...
        self.assertEqual(
            common.KEY_ENCODED_PREV_LABEL, "prev_image/segmentation/class/encoded"
        )
        self.assertEqual(common.KEY_ENCODED_LABEL, "image/segmentation/class/encoded")
