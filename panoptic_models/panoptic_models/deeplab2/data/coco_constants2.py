...
_CLASS_MAPPING = {
    ...
    "bridge": {"name": "bridge", "id": 8, "color": [150, 100, 101]},
    "door-stuff": {"name": "building-other-merged", "id": 9, "color": [116, 112, 1]},
    "house": {"name": "building-other-merged", "id": 9, "color": [116, 112, 1]},
    "roof": {"name": "building-other-merged", "id": 9, "color": [116, 112, 1]},
    "stairs": {"name": "building-other-merged", "id": 9, "color": [116, 112, 1]},
    "window-other": {"name": "building-other-merged", "id": 9, "color": [116, 112, 1]},
...
CLASS_HAS_INSTANCE_LIST = np.arange(1, 8)
...
def get_reduced_colormap_and_names():
    """Get the reduced colormap and class names."""
    colormap = np.zeros((256, 3), dtype=np.uint8)
    class_names = []
    class_names.append("unknown")
    for value in _CLASS_MAPPING.values():
        if value["name"] not in class_names:
            class_names.append(value["name"])
            colormap[value["id"]] = value["color"]
