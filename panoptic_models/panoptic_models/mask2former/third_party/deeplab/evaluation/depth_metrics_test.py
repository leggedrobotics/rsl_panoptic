...
class DepthMetricsTest(tf.test.TestCase):
    def test_depth_metrics_on_single_image(self):
        gt = np.array(
            [
                [5.44108091, 53.30197697, 61.06181767, 14.36723114],
        ...
        pred = np.array(
            [
                [4.87694111, 50.09085582, 55.74533641, 10.13579195],
    ...
    def test_depth_metrics_on_multiple_images(self):
        ...
        gt_3 = np.array(
            [
                [50.80100791, 0.41130084, 58.85031668],
                [29.44932853, 23.48806627, 30.17890056],
            ]
        )
        pred_3 = np.array(
            [
                [49.66563966, 0.62070026, 58.84231026],
