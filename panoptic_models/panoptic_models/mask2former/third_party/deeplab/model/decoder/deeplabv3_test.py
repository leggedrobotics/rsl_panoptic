...
def _create_deeplabv3_model(
    feature_key, decoder_channels, aspp_channels, atrous_rates, num_classes, **kwargs
):
...
class Deeplabv3Test(tf.test.TestCase):
    ...
    def test_deeplabv3_pool_size_setter(self):
        ...
        self.assertTupleEqual(deeplabv3_decoder._aspp._aspp_pool._pool_size, pool_size)
