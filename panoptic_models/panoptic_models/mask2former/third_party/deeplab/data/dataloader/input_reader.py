...
class InputReader(object):
    ...
    def __init__(self, file_pattern, decoder_fn, generator_fn=None, is_training=False):
    ...
    def __call__(self, batch_size=1, max_num_examples=-1):
        ...
        if self._is_training:
            ...
            dataset = dataset.shuffle(
                dataset.cardinality(), reshuffle_each_iteration=True
            )
        ...
        dataset = dataset.interleave(
            ...
            cycle_length=(
                _NUM_INPUTS_PROCESSED_CONCURRENTLY if self._is_training else 1
            ),
