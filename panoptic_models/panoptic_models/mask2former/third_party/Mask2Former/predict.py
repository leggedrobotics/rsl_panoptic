...
# import panoptic_models.mask2former project
from panoptic_models.mask2former import add_maskformer2_config
...
class Predictor(cog.Predictor):
    ...
    def predict(self, image):
        ...
        semantic_result = v.draw_sem_seg(
            outputs["sem_seg"].argmax(0).to("cpu")
        ).get_image()
        result = np.concatenate(
            (panoptic_result, instance_result, semantic_result), axis=0
        )[:, :, ::-1]
