...
class MotionDeepLabDecoder(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        if motion_deeplab_options.instance.HasField("instance_decoder_override"):
            decoder_options = motion_deeplab_options.instance.instance_decoder_override
    ...
    def checkpoint_items(self):
        ...
        if self._instance_decoder is not None:
            instance_items = {
                ...
                common.CKPT_MOTION_REGRESSION_HEAD_WITHOUT_LAST_LAYER: self._motion_regression_head.conv_block,
                common.CKPT_MOTION_REGRESSION_HEAD_LAST_LAYER: self._motion_regression_head.final_conv,
            }
