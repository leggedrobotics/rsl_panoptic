...
def _create_deeplabv3plus_model(
    high_level_feature_name,
    low_level_feature_name,
    ...
    **kwargs
    ...
    return deeplabv3plus.DeepLabV3Plus(decoder_options, deeplabv3plus_options, **kwargs)
...
class Deeplabv3PlusTest(tf.test.TestCase):
    ...
    def test_deeplabv3plus_feature_extraction_consistency(self):
        ...
        reference_logits_tensor = deeplabv3plus_decoder(input_dict, training=False)
    ...
    def test_deeplabv3plus_pool_size_setter(self):
        ...
        self.assertTupleEqual(
            deeplabv3plus_decoder._aspp._aspp_pool._pool_size, pool_size
        )
