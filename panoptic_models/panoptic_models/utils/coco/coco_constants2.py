# Author: Pascal Roth and Simin Fei
...
# import parameters
from panoptic_models.panoptic_models.config.params_meta import _UNKNOWN_ID
...
CLASS_HAS_INSTANCE_LIST = [1, 2, 3, 4, 5, 6, 7]
...
def get_id_mapping() -> Mapping[int, int]:
    ...
    for meta in _COCO_META:
        if meta["name"] in reduced_class_list:
            ...
            id_mapping[meta["id"]] = _UNKNOWN_ID
    return id_mapping
