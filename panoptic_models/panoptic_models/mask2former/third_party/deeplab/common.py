...
CKPT_INSTANCE_CENTER_HEAD_WITHOUT_LAST_LAYER = (
    "instance_center_head" "_without_last_layer"
)
CKPT_INSTANCE_CENTER_HEAD_LAST_LAYER = "instance_center_head_last_layer"
CKPT_INSTANCE_REGRESSION_HEAD_WITHOUT_LAST_LAYER = (
    "instance_regression_head" "_without_last_layer"
)
CKPT_INSTANCE_REGRESSION_HEAD_LAST_LAYER = "instance_regression_head_last_layer"

# Motion-DeepLab
CKPT_MOTION_REGRESSION_HEAD_WITHOUT_LAST_LAYER = (
    "motion_regression_head" "_without_last_layer"
)
...
TASK_DEPTH_AWARE_VIDEO_PANOPTIC_SEGMENTATION = "depth_aware_video_panoptic_segmentation"
